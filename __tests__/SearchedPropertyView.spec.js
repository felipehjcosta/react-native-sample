...
describe('<SearchedPropertyView>', () => {
    ...
    it('should render the correct price', () => {
        ...
        expect(wrapper.containsMatchingElement(<Text>{formatted_price}</Text>)).to.equal(true);
    });

    it('should render the image', () => {
        expect(wrapper.containsMatchingElement(<Image source={{uri: data.img_url}}/>)).to.equal(true);
    });
    ...
    it('should render the stats', () => {
        ...
        expect(wrapper.containsMatchingElement(<Text>{stats}</Text>)).to.equal(true);
    });

    it('should render the summary', () => {
        expect(wrapper.containsMatchingElement(<Text>{data.summary}</Text>)).to.equal(true);
    });
